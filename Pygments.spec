...
Source0  : https://files.pythonhosted.org/packages/1d/60/bb5bdd45e28a5acecf9273350b903fb8151ed899c4a384c983efd8a6730b/Pygments-2.11.0.tar.gz
...
%prep
%setup -q -n Pygments-2.11.0
cd %{_builddir}/Pygments-2.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640889919
...
cp %{_builddir}/Pygments-2.11.0/LICENSE %{buildroot}/usr/share/package-licenses/Pygments/0c9b9b4787b4a052032ee71b856e9a8d37a13ea3
