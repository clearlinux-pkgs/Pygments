...
%prep
%setup -q -n Pygments-2.5.2
cd %{_builddir}/Pygments-2.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583451959
...
cp %{_builddir}/Pygments-2.5.2/LICENSE %{buildroot}/usr/share/package-licenses/Pygments/be18f7a5141217b0e22c9ab3e23de10c900fb2d6
